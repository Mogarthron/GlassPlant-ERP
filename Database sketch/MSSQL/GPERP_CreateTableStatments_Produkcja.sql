...
create table DziennyPlanProdukcji(
	...
	zatwierdzeniePlanu nvarchar(50), -- np mail z 29.10.2020
...
create table ZespolFormujacy(
	...
	SymbolWarszatuRoboczego nvarchar(10), -- np. WG_1, WG_6, WW_1
	wprowadzeniePozycji datetime2 default GetDate(), --mo¿e pos³u¿yæ do utworzenia nr karty formowania
	poczatekProdukcji datetime2,
	koniecProdukcji datetime2,
	przestojTechniczny smallint -- minuty	
);
